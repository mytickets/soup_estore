...
echo "<hr>";        
        ...
        $ii=0;
        echo count($array2["RK7Reference"]["Items"]['Item']);
        echo "<br>";
        ...
        foreach ($array2["RK7Reference"]["Items"]['Item'] as $itemp) {
            ...
            if ($itemp['@attributes']['PriceType']=="3") {
                ...
                if ("9223372036854775807"!=$itemp['@attributes']['Value']) {
                    ...
                    // if ($itemp['@attributes']['Value']>0) {
                        echo "id:".$itemp['@attributes']['ObjectID']." v:".$itemp['@attributes']['Value'];
                        echo "<br>";
                        $p = Product::find($itemp['@attributes']['ObjectID']);
                        if ($p) {
